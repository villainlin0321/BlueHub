  ...
  static const List<_JobCardItem> _jobs = <_JobCardItem>[
    _JobCardItem(
      data: JobPositionCardData(
        ...
        company: '柏林老四川餐厅',
        location: '德国·柏林',
        companyAvatarAssetPath: 'assets/images/jobs/mou2x9mw-w0z6m1f.png',
        locationIconAssetPath: 'assets/images/jobs/mou2x9mw-vdptc5a.svg',
    ...
    _JobCardItem(
      data: JobPositionCardData(
        ...
        location: '德国·柏林',
        companyAvatarAssetPath: 'assets/images/jobs/mou2x9mw-w0z6m1f.png',
        locationIconAssetPath: 'assets/images/jobs/mou2x9mw-i9nkf4t.svg',
        showApplyButton: true,
      ),
    ),
    _JobCardItem(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        children: <Widget>[
          AppSvgIcon(
            assetPath: 'assets/images/jobs/mou2x9mw-2jfef5b.svg',
  ...
  Widget build(BuildContext context) {
    return const Row(
      ...
      children: <Widget>[
        _DropdownChip(
          label: '全部国家',
          iconAssetPath: 'assets/images/jobs/mou2x9mw-y3xkvto.png',
          width: 88,
        ),
        _DropdownChip(
          label: '全部分类',
        ...
        _DropdownChip(
          label: '薪资要求',
          iconAssetPath: 'assets/images/jobs/mou2x9mw-flxj53h.png',
          width: 88,
          highlighted: true,
        ),
        _FilterActionChip(),
    ...
    return Container(
      ...
      child: const Row(
        children: <Widget>[
          ...
          SizedBox(width: 4),
          AppSvgIcon(
            assetPath: 'assets/images/jobs/mou2x9mw-6xvx4hp.svg',
